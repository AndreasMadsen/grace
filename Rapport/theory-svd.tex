...
The above mentioned analysis goes under the umbrella term ``Principal Component Analysis (PCA)'', where a ``principal component'' should be understood as the axes in the transformed space (i.e., the eigenvectors). \todo{Is the term ``principal component'' correct, score, loading ?}

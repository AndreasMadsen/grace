...
It then finds the attribute, $b_1$, with the highest absolute correlation with the dependent variable Y and increases \todo{what increases} (or decreases depending on the sign of the correlation)
